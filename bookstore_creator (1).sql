...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 02, 2020 at 08:10 AM
...
(1, 'All The Light We Cannot See', 'Anthony Doerr', 'All the Light We Cannot See is a war novel written by American author Anthony Doerr, published by Scribner on May 6, 2014. It won the 2015 Pulitzer Prize for Fiction and the 2015 Andrew Carnegie Medal for Excellence in Fiction', 75, 79, 'images/book1.jpg'),
...
INSERT INTO `users` (`user_id`, `first_name`, `last_name`, `payment`) VALUES
(1, 'narinder', 'sandhu', 'Credit card'),
(2, 'abcd', 'mnb', 'Debit Card');
